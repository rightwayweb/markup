...
/**
 * This class represents an html ins tag. An ins tag has two attributes. They are
 ...
 * @version $Id: Ins.java,v 1.1.1.1 2008/02/20 15:01:12 jglorioso Exp $
 * @see TextEffectFactory#getTextEffect(TextEffectType, HtmlMarkupTag)
 */
public class Ins extends TextEffect
{
    ...
    /**
     * Creates a new ins tag with no parent.
     */
    public Ins()
    {
        super("ins");
    ...
    /**
     * Creates a new ins tag with an HtmlMarkupTag parent.
     *
     * @param parent The parent.
     */
    public Ins(HtmlMarkupTag parent)
    {
        super("ins", parent);
    }
